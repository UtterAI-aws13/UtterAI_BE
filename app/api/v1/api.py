...
from app.api.v1.endpoints.analysis_result import router as analysis_result_router
...
api_v1_router.include_router(session_analysis_result_router, prefix="/sessions", tags=["sessions"])
